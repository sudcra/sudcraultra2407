select 
	...
	desc_larga2,
	logro2,
	url_retro2 as url_retro

	from (SELECT 
	inscripcion.id_seccion, 
	matricula_eval.id_matricula_eval, 	  
...
join
  (SELECT 
   ...
   matricula_eval.id_matricula_eval as id_matricula_eval2 , 	  
...
HAVING 
	inscripcion.id_seccion=[id_seccion] AND 
	matricula_eval.id_eval='[id_eval]')as medidas_seccionil  on medidas_seccion.id_medida = medidas_seccionil.dependencia2 and 
	medidas_seccion.id_matricula_eval = medidas_seccionil.id_matricula_eval2
	
	where tipo_medida_cod='[medida]'
	order by id_matricula_eval, orden, orden2
	;